...
config :phoenix_demo, PhoenixDemoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "PzYib7gejSIJtD04nqYGoM18kSQVm7Fzy6ydEYPyKlDY4FNYGQKdsZFJajfJwl63",
  watchers: [
...
config :phoenix_demo, PhoenixDemoWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/phoenix_demo_web/router\.ex$",
      ~r"lib/phoenix_demo_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
