      ...
      <div className="container px-5 py-24 mx-auto rounded-3xl bg-slate-100">
        <div className="flex flex-col w-full text-center">
          ...
          <p className="mx-auto text-base leading-relaxed lg:w-2/3">
            TreeLocatorJS is open source (MIT license). You can help by making a
            pull request, creating an issue, or spreading the word.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 mt-8 sm:flex-row">
            ...
            <a
              href="https://github.com/wende/treelocatorjs/issues"
